...
> **Jawab:**
> 1. Git <br>
> ![Instalasi Git](belajar-react/hello-world/img/instalasi-git.png)
>
> 2. VS Code <br>
>![Instalasi VSCode](belajar-react/hello-world/img/instalasi-vscode.png)
>
> 3. NodeJS <br>
> ![Instalasi NodeJS](belajar-react/hello-world/img/instalasi-nodejs.png)
...
dimasukkan pertama kali melalui konsol.
    > **Pengerjaan:** <br>
    > ![Buat Proyek Baru](belajar-react/hello-world/img/buat-proyek-baru.png)
...
Maka VS Code akan membuka project react Anda yang telah dibuat bernama `hello-world`. Dan akan menampilkan struktur folder proyek seperti di bawah ini.
    > **Pengerjaan:** <br>
    > ![Struktur Folder](belajar-react/hello-world/img/struktur-folder.png)
...
browser: http://localhost:3000/
    > **Pengerjaan:** <br>
    > ![Running](belajar-react/hello-world/img/running-proyek.png)

Jika di browser telah tampil seperti gambar berikut ini, Selamat! <br>
![Hasil Running](belajar-react/hello-world/img/hasil-praktikum2.png)
...
2. Tambahkan fungsi MyButton yang mengembalikan markup komponen button yang akan ditambahkan ke dalam webpage
    > **Pengerjaan:** <br>
    > ![Fungsi Button](belajar-react/hello-world/img/fungsi-button.png)

3. Tambahkan komponen button tersebut di samping button Read Our Docs. 
    > **Pengerjaan:** <br>
    > ![Komponen Button](belajar-react/hello-world/img/komponen-button.png)
...
> **Jawab:** <br>
> ![Hasil Praktikum3](belajar-react/hello-world/img/hasil-praktikum3.png)
...
1. Tambahkan kode JSX di bawah ini ke dalam file page.tsx.
    > **Pengerjaan:** <br>
    > ![Kode JSX](belajar-react/hello-world/img/kode-jsx.png)

2. Tambahkan komponen MyProfile setelah komponen MyButton.
    > **Pengerjaan:** <br>
    > ![Komponen MyProfile](belajar-react/hello-world/img/komponen-myprofile.png)
...
> **Jawab:** <br>
> ![Hasil Praktikum 4](belajar-react/hello-world/img/hasil-praktikum4.png)
